...
$route['api/mobile/properties/published'] = 'Api_mobile/published_properties';
$route['api/mobile/properties/best-rate'] = 'Api_mobile/best_rate_properties';
$route['api/mobile/properties/high-growth'] = 'Api_mobile/high_growth_properties';
$route['api/mobile/properties/recommended'] = 'Api_mobile/recommended_properties';
$route['api/mobile/properties/newly-launched'] = 'Api_mobile/newly_launched_properties';
$route['api/mobile/properties/verified'] = 'Api_mobile/verified_properties';
$route['api/mobile/properties/premium'] = 'Api_mobile/premium_properties';
$route['api/mobile/properties/home-banner'] = 'Api_mobile/home_banner_properties';
...
$route['api/mobile/reels'] = 'Api_mobile/reels';
$route['api/mobile/reels/create'] = 'Api_mobile/reels_create';
$route['api/mobile/reels/update/(:num)'] = 'Api_mobile/reels_update/$1';
$route['api/mobile/reels/delete/(:num)'] = 'Api_mobile/reels_delete/$1';
$route['api/mobile/reels/reorder'] = 'Api_mobile/reels_reorder';
$route['api/mobile/reels/(:num)'] = 'Api_mobile/reel/$1';
$route['api/mobile/videos'] = 'Api_mobile/videos';
$route['api/mobile/videos/create'] = 'Api_mobile/videos_create';
$route['api/mobile/videos/update/(:num)'] = 'Api_mobile/videos_update/$1';
$route['api/mobile/videos/delete/(:num)'] = 'Api_mobile/videos_delete/$1';
$route['api/mobile/videos/reorder'] = 'Api_mobile/videos_reorder';
$route['api/mobile/videos/(:num)'] = 'Api_mobile/video/$1';
...
$route['api/mobile/kyc-history'] = 'api_nb_app/kyc_history';
$route['api/mobile/kyc_history'] = 'api_nb_app/kyc_history';
$route['api/mobile/kyc-history/(:num)'] = 'api_nb_app/kyc_history/$1';
$route['api/mobile/kyc_history/(:num)'] = 'api_nb_app/kyc_history/$1';
...
$route['panel/reject-property'] = 'broker_admin/reject_property';
...
$route['panel/property/view/(:num)'] = 'broker_admin/property_view/$1';
...
$route['api/amenities'] = 'api_amenities/index';
$route['api/amenities/toggle'] = 'api_amenities/toggle';
$route['api/nb/amenities'] = 'api_amenities/index';
$route['api/mobile/amenities'] = 'api_amenities/index';
...
$route['api/nb/kyc_history'] = 'api_nb_app/kyc_history';
$route['api/nb/kyc-history/(:num)'] = 'api_nb_app/kyc_history/$1';
$route['api/nb/kyc_history/(:num)'] = 'api_nb_app/kyc_history/$1';
$route['api/nb/register'] = 'api_nb_app/register';
$route['api/nb/login'] = 'api_nb_app/login';
$route['api/nb/send-otp'] = 'api_nb_app/send_otp';
$route['api/nb/send_otp'] = 'api_nb_app/send_otp';
$route['api/nb/verify-otp'] = 'api_nb_app/verify_otp';
$route['api/nb/verify_otp'] = 'api_nb_app/verify_otp';
$route['api/nb/resend-otp'] = 'api_nb_app/resend_otp';
$route['api/nb/resend_otp'] = 'api_nb_app/resend_otp';
