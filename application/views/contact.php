...
<section class="flat-title-page flat-title-page--contact">
    <div class="container">
        <div class="breadcrumb-content">
            ...
            <div
                class="contact-page-hero-meta text-center mt-3 d-flex flex-wrap justify-content-center align-items-center">
                <a href="tel:<?php echo preg_replace('/\s+/', '', $phone_tel); ?>"
                    class="link-primary d-inline-flex align-items-center justify-content-center gap-2 mx-2 mx-md-3 mb-2 mb-md-0 contact-hero-link">
                ...
                <a href="mailto:<?php echo htmlspecialchars($email_addr); ?>"
                    class="link-primary d-inline-flex align-items-center justify-content-center gap-2 mx-2 mx-md-3 contact-hero-link">
                    <span class="contact-hero-icon" aria-hidden="true">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="contact-content">
                    ...
                    <form id="contactform" method="post" action="<?php echo base_url('contact/submit'); ?>"
                        class="form-contact">
                        ...
                        <div class="box grid-2">
                            <fieldset>
                                ...
                                <small class="text-variant-1 d-block mt-1">10-digit Indian mobile: use +91 and space as
                                    shown (e.g. <?php echo htmlspecialchars($phone_display); ?>).</small>
                            </fieldset>
                            <fieldset>
                        ...
                        <div class="send-wrap">
                            <button class="tf-btn primary size-1" type="submit" id="contactSubmitBtn">Send
                                Message</button>
                        </div>
                    </form>
                </div>
                    ...
                    <ul>
                        ...
                        <li class="box">
                            ...
                            <p class="text-variant-1 mb-3">
                                <a href="tel:<?php echo preg_replace('/\s+/', '', $phone_tel); ?>"
                                    class="link-primary text-decoration-underline"><?php echo htmlspecialchars($phone_display); ?></a>
                            </p>
                            <h6 class="title">Mail ID:</h6>
                            <p class="text-variant-1 mb-0">
                                <a href="mailto:<?php echo htmlspecialchars($email_addr); ?>"
                                    class="link-primary text-decoration-underline"><?php echo htmlspecialchars($email_addr); ?></a>
                            </p>
                        </li>
                        <li class="box">
                        ...
                        <li class="box">
                            ...
                            <ul class="box-social">
                                <li><a href="https://www.facebook.com/Dreamvillamakers" class="item" target="_blank"
                                ...
                                <li><a href="https://www.instagram.com/dreamvillamakers" class="item" target="_blank"
                                ...
                                <li><a href="https://www.youtube.com/@DreamVillaMakers" class="item" target="_blank"
            ...
            <div class="col-12">
                <div class="contact-map-block">
                    ...
                    <div class="contact-map-wrap ratio ratio-16x9">
                        <iframe title="Coimbatore Properties — location on Google Maps"
                            src="<?php echo htmlspecialchars($contact_map_embed_url); ?>" class="contact-map-iframe"
                            loading="lazy" allowfullscreen referrerpolicy="no-referrer-when-downgrade"
                            aria-label="Google Map showing our office location"></iframe>
                    </div>
                    <p class="mt-3 mb-0">
                        <a href="<?php echo htmlspecialchars($contact_maps_open_url); ?>"
                            class="link-primary text-decoration-underline" target="_blank"
                            rel="noopener noreferrer">Open this location in Google Maps</a>
                    </p>
                </div>
            </div>
        </div>
