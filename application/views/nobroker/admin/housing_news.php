...
<div class="nb-admin-page-head d-flex flex-wrap justify-content-between align-items-start gap-3">
  <div>
    <h1 class="nb-admin-page-title">Blogs</h1>
    <p class="nb-admin-page-desc mb-0">Articles shown on the website and mobile app via <code>/api/blogs</code> and <code>/api/mobile/blogs</code>.</p>
  </div>
...
<div class="nb-admin-panel">
  <div class="nb-admin-panel-header">
    <h2 class="nb-admin-panel-title mb-0">All blogs</h2>
  ...
  <div class="nb-admin-panel-body">
    <div class="nb-admin-table-wrap">
      ...
      <tbody>
      <?php if (empty($rows)) : ?>
        <tr><td colspan="6" class="text-center text-muted py-5">No blogs yet. Add one to populate <code>/api/mobile/blogs</code>.</td></tr>
        ...
        <tr>
          ...
          <td class="text-end">
            <div class="d-inline-flex align-items-center gap-2 flex-nowrap">
              ...
              <form action="<?php echo site_url('panel/housing-news/delete/' . (int) $r->id); ?>" method="post" class="m-0" onsubmit="return confirm('Delete this blog article?');">
