...
<?php if ($is_landing || $nb_full_footer): ?>
  <footer class="nb-footer-site nb-footer-landing <?php echo $is_landing ? 'mt-0' : 'mt-5'; ?>">
    <div class="container">
      <div class="row g-4">
        <div class="col-lg-5">
          <div class="nb-footer-brand mb-2"><i class="bi bi-house-heart-fill nb-text-brand me-1"></i>Coimbatore Properties
          </div>
          <p class="small text-white-50 mb-4">Find rental homes and properties for sale — verified listings, zero
            brokerage.</p>
          ...
          <?php if (!empty($nb_admin_contact)): ?>
            <p class="small text-white-50 mb-0"><i class="bi bi-envelope me-1"></i><a
                href="mailto:<?php echo html_escape($nb_admin_contact); ?>"
                class="text-white-50"><?php echo html_escape($nb_admin_contact); ?></a></p>
          <?php endif; ?>
        </div>
        <div class="col-6 col-lg-3">
          ...
          <ul class="list-unstyled small mb-0">
            ...
            <?php if ($nb_footer_guest): ?>
              <li class="mb-2"><a href="<?php echo base_url(); ?>?modal=login" data-bs-toggle="modal"
                  data-bs-target="#nbModalLogin">Login</a></li>
              <li><a href="<?php echo base_url(); ?>?modal=register" data-bs-toggle="modal"
                  data-bs-target="#nbModalRegister">Register</a></li>
            <?php else: ?>
        ...
        <div class="col-6 col-lg-4">
          ...
          <ul class="list-unstyled small mb-0">
            ...
            foreach ($cities_footer as $c):
              ...
              ?>
              <li class="mb-2"><a
                  href="<?php echo site_url('search?' . http_build_query(array('city_id' => $c->id))); ?>"><?php echo html_escape($c->name); ?></a>
              </li>
            <?php endforeach; ?>
          </ul>
        </div>
      ...
      <div
        class="nb-footer-legal d-flex flex-column flex-md-row align-items-center justify-content-between gap-2 gap-md-3 small text-white-50 w-100">
        <span class="text-center text-md-start mb-0">&copy; <?php echo date('Y'); ?> Coimbatore Properties. All rights
          reserved.</span>
    ...
    <div class="container">
      <div class="row g-4 g-lg-5">
        <div class="col-lg-5">
          ...
          <p class="small text-white-50 mb-3 mb-lg-4">Find rental homes and properties for sale — verified listings, zero
            brokerage.</p>
          <div class="d-flex gap-3 mb-3">
            <a href="#" class="fs-5" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
            <a href="#" class="fs-5" aria-label="Twitter"><i class="bi bi-twitter"></i></a>
