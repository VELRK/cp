...
export default function LiveUpdateModal({ show, onClose, onSuccess }: LiveUpdateModalProps) {
  ...
  return (
    <div className="modal fade show d-block" tabIndex={-1} style={{ backgroundColor: 'rgba(7, 31, 63, 0.4)', backdropFilter: 'blur(8px)', zIndex: 1050 }}>
        ...
        <div className="modal-content border-0 shadow-lg rounded-4 animate-fade-in">
          ...
          <div className="modal-body">
            <form onSubmit={handleLiveUpdateSubmit}>
              ...
              <button type="submit" className="btn btn-primary w-100 fw-bold py-2.5 rounded-pill nb-btn-nav-outline" disabled={liveUpdateSubmitting}>
